							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										...
										<td class="typeRead">
											<button id="bt_read1" class="btn"><i class="far fa-envelope"></i></button>
											<button id="bt_read2" class="btn" style="display: none;"><i class="far fa-envelope-open"></i></button>
										</td>
										<td class="typeInportant">
											<button id="bt_important1" class="btn"><i class="fas fa-star"></i></button>
											<button id="bt_important2" class="btn" style="display: none;"><i class="far fa-star"></i></button>
										</td>
										<td class="typeFile"><i class="far fa-file btn"></i></td>
										<td class="typeName"><a href="#">Larry Gardner</a></td>
										<td class="typeSubject"><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed </a></td>
										<td class="typeTime">08:30 PM</td>
									</tr>
									<!-- 반복끝 -->
								</tbody>
								</table>
