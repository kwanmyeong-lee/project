	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion"
			...
			<div class="scheduleAdd" id="divscheduleAdd">
				<button type="button" class="btn btn-light btnSchAdd">예약</button>
			</div>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapse1"> <i
					class="fas fa-fw fa-cog"></i> <span>본사 1층 회의실</span>
            ...
            <li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapse2"> <i
					class="fas fa-fw fa-cog"></i> <span>본사 5층 회의실</span>
            ...
            <li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapse3"> <i
					class="fas fa-fw fa-cog"></i> <span>차량</span>
             ...
             <li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapse4"> <i
					class="fas fa-fw fa-cog"></i> <span>빔프로젝터</span>
