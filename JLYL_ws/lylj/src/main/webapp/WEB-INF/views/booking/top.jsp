		...
		<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion"
            ...
            <li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapse3"> <i
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons">7498 아반떼</a>
                        <a class="collapse-item" href="buttons">3929 아반떼</a>
                    </div>
                </div> </li>
             ...
             <li class="nav-item"><a class="nav-link collapsed " href="#"
				...
				aria-expanded="true" aria-controls="collapse4"> <i
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons">1번 빔프로젝터</a>
                        <a class="collapse-item" href="buttons">2번 빔프로젝터</a>
                    </div>
                </div> </li>
