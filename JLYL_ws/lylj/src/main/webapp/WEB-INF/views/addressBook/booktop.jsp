...
<body>
	...
	<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion"
		...
		<a
			...
			href="<c:url value="/index"/>"><div
				class="sidebar-brand-text mx-3">메인으로이동</div></a>
		<!--Heading-->
				...
				<form name="frmBookWrite"
					...
					<div id="bookWriteDiv">
						...
						<div id="positionInputDiv" class="boxDiv">
							<label>직급</label><span class="splitSpan">:</span><select
								name="addressBookPosition" id="" class="selectItem"><option
									value="사원">사원</option>
