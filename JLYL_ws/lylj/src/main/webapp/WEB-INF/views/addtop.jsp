...
<body id="page-top">
   ...
   <div id="wrapper">
     ...
     <!--Sidebar--><ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar"><!--Sidebar-Brand--><a class="sidebar-brand d-flex align-items-center justify-content-center " href="<c:url value="/index"/>">
        <div class="sidebar-brand-text mx-3">메인으로이동</div>
    </a>
    <hr class="sidebar-divider d-none d-md-block white"><!--Heading--><a class="adminMain" id="adminMain" href="<c:url value="/admin"/>">
            <div class="sidebar-brand-text mx-3 ">관리자메인</div>
        </a><!--Divider--><!--Nav Item-Pages Collapse Menu--><li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#collapseOne" data-bs-toggle="collapse" role="button" aria-expanded="ture" aria-controls="collapseOne">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#collapseTwo" data-bs-toggle="collapse" role="button" aria-expanded="true">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#collapseThree" data-bs-toggle="collapse" role="button" aria-expanded="true">
                <i class="far fa-edit"></i>
                <span>근태관리</span>
            </a>
            <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="<c:url value='/assiduity/excess'/>">초과근무승인</a>
                </div>
            </div>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#collapseFour" data-bs-toggle="collapse" role="button" aria-expanded="true">
                <i class="far fa-edit"></i>
                <span>예약관리</span>
            </a>
            <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="<c:url value='/booking/rent'/>">예약승인</a>
                    <a class="collapse-item" href="<c:url value='/booking/property'/>">자산관리</a>
                </div>
            </div>
        </li>
    </ul>
